  ...
  return (
    <section className="py-20 px-6 max-w-5xl mx-auto relative z-10">
      <ScrollReveal enableBlur={true} baseOpacity={0.05} baseRotation={1}>
        <div className="relative overflow-hidden p-10 md:p-16 text-center space-y-8 border border-[#00D4FF]/15 rounded-3xl shadow-2xl flex flex-col items-center" style={{ background: "linear-gradient(135deg, #060D18 0%, #0A1628 100%)" }}>
          {/* Faint cyan aurora inside card */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,212,255,0.04)_0%,transparent_60%)] pointer-events-none" />
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <p className="text-sm md:text-base text-[#7A9BB5] leading-relaxed font-light max-w-xl mx-auto">
